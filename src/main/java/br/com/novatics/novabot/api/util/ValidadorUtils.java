...
public class ValidadorUtils {
		...
		for (Object obj : objs) {
			...
			if (obj != null) {
				...
				if (obj instanceof Modelo) {
					if (isNotNullAndValid((Modelo) obj)) {
						return false;
					}
				}
	...
	public static boolean isNotNullAndValid(Modelo model) {
	...
	public static boolean isNullOrInvalid(Modelo model) {
	...
	public static Integer compararRetornandoIntegerAlteradoOuNulo(String anom, String real) {
		...
		if (ValidadorUtils.compararRetornandoAlteradoOuNulo(anom, real) != null) {
	...
	public static String compararRetornandoAlteradoOuNulo(String anom, String real) {
		...
		if (ValidadorUtils.isNullOrEmpty(anom) || !anom.equalsIgnoreCase(real)) {
			return real;
		}
